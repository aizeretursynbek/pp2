...
image_surface = pygame.image.load('image/clock.png').convert_alpha()
mickey        = pygame.image.load( 'image/mUmrP.png').convert_alpha()
hand_l        = pygame.image.load( 'image/hand_left.png').convert_alpha()
hand_r        = pygame.image.load( 'image/hand_right.png').convert_alpha()
